...
func TestSvn(t *testing.T) {
	...
	if repo.Remote() != "https://github.com/andrewlunde/VCSTestRepo/trunk" {
	...
	_, nrerr := NewSvnRepo("https://github.com/andrewlunde/VCSTestRepo/unknownbranch", tempDir+"/VCSTestRepo")
	...
	// nrepo, nrerr := NewRepo("https://github.com/andrewlunde/VCSTestRepo/trunk", tempDir+"/VCSTestRepo")
	// if nrerr != nil {
	// 	t.Error(nrerr)
	// }
...
func TestSvnCheckLocal(t *testing.T) {
	...
	_, nrerr := NewRepo("https://github.com/andrewlunde/VCSTestRepo/trunk", tempDir+"/VCSTestRepo")
	if nrerr != nil {
		t.Error(nrerr)
	}
}
...
func TestSvnPing(t *testing.T) {
	...
	repo, err := NewSvnRepo("https://github.com/andrewlunde/VCSTestRepo/trunk", tempDir)
	if err != nil {
		t.Error(err)
	}
	...
	repo, err = NewSvnRepo("https://github.com/andrewlunde/ihopethisneverexistsbecauseitshouldnt", tempDir)
	if err != nil {
		t.Error(err)
	}
